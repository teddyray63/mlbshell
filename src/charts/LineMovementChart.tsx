...
const CustomTooltip = memo(function CustomTooltip({ active, payload, label }: { active?: boolean; payload?: Array<{ dataKey: string; name: string; value: number; color: string }>; label?: string }) {
...
const LineMovementChart = memo(function LineMovementChart({ data = defaultData, height = 200 }: LineMovementChartProps) {
  return (
    <div role="img" aria-label="Line movement chart showing over/under total changes throughout the day">
