                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-right">
                      <span
                        className={`stat-cell font-semibold ${parseFloat(player.woba) >= 0.36 ? 'text-positive' : parseFloat(player.woba) <= 0.31 ? 'text-negative' : 'text-foreground'}`}
                      >
                        {player.woba}
                      </span>
                    </td>
                    ...
                    <td className="px-3 py-2.5 text-right">
                      <span
                        className={`stat-cell font-semibold ${isHighBarrel ? 'text-positive' : 'text-foreground'}`}
                      >
                    ...
                    <td className="px-3 py-2.5 text-right">
                      <span
                        className={`stat-cell ${isHighK ? 'text-negative font-semibold' : 'text-foreground'}`}
                      >
                        {player.kPct.toFixed(1)}%
                      </span>
                    </td>
                    <td className="px-3 py-2.5 text-right stat-cell text-muted-foreground">
                      {player.bbPct.toFixed(1)}%
                    </td>
                  </tr>
                );
              })
