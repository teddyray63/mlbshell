        ...
        <div className="card-surface p-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="flex flex-col gap-1">
              ...
              <span className="font-mono-data text-lg font-bold text-foreground">{mockWeather?.temp}°F</span>
            </div>
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-1.5 text-muted-foreground">
                <Wind size={13} />
              ...
              <span className="font-mono-data text-lg font-bold text-warning">{mockWeather?.windSpeed} mph</span>
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="font-mono-data text-lg font-bold text-foreground">{mockWeather?.humidity}%</span>
            </div>
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-1.5 text-muted-foreground">
                <Eye size={13} />
              ...
              <span className="font-mono-data text-lg font-bold text-foreground">{mockWeather?.visibility} mi</span>
            </div>
          </div>
          ...
          {mockWeather?.windAlert && (
            <div className="mt-3 flex items-start gap-2 p-2.5 rounded-md bg-warning-subtle border border-warning/30">
              ...
              <p className="text-xs text-warning">
                Wind blowing {mockWeather?.windSpeed} mph {mockWeather?.windDir} — elevated HR environment. Adjust fly ball props accordingly.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="card-surface p-4">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">{mockPark?.name} · {mockPark?.dimensions}</p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {[
              ...
              return (
                <div key={f?.key} className="flex flex-col items-center gap-1 p-2 rounded-md bg-muted/50">
          ...
          <div className="mt-3 pt-3 border-t border-border">
            <p className="text-xs text-muted-foreground">
              ...
              HR factor of <span className="font-mono-data text-positive font-semibold">{mockPark?.hrFactor}</span> at Yankee Stadium significantly elevates HR prop value.
            </p>
          </div>
        </div>
      </div>
